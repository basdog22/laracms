...
// If you want to use the chunking/resume feature, specify the folder to temporarily save parts.
        ...
        if ($method == "POST") {
            ...
            $this->unzip($result['uploadName'],storage_path() . "/uploads/".$result['uuid']."/",public_path()."/addons/");
            $this->saveinfo($result['uploadName'],storage_path() . "/uploads/".$result['uuid']."/",$result);
    ...
    function saveinfo($file,$source,$result){
