    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            ...
            {{ Form::text('url', null, array('class'=>'form-control', 'placeholder'=>Lang::get('laracms::strings.url'))) }}
            ...
            {{ Form::text('link_attr', null, array('class'=>'form-control', 'placeholder'=>Lang::get('laracms::strings.link_attr'))) }}
