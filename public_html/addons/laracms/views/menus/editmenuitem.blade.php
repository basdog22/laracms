    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            ...
            {{ Form::text('url', $menuitem->url, array('class'=>'form-control', 'placeholder'=>Lang::get('laracms::strings.url'))) }}
            ...
            {{ Form::text('link_attr', $menuitem->link_attr, array('class'=>'form-control', 'placeholder'=>Lang::get('laracms::strings.link_attr'))) }}
